<template>
  <div class="notfound-container" v-if="state.display">
    ...
    <p>
      Sorry - this page doesn't exist. If you followed a link in the
      documentation to get here, feel free to update that file in GitHub.
    </p>

    <div style="margin-bottom: 10px">
      <RouterLink to="/">Developer Portal →</RouterLink>
    </div>
  </div>
</template>
